...
#Slurm parameters
#SBATCH --job-name=weight_8.16KVD
#SBATCH --output=weight_8.16KVD.out
#SBATCH --ntasks=1
...
CUDA_VISIBLE_DEVICES=0 python test_kvd.py  --name weight_8.16  --dataset_mode gtavtocityscapes --gpu_ids 0 \
