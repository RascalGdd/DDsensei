...
def add_all_arguments(parser, train):
    ...
    parser.add_argument('--add_edges', action='store_true',
                        help='use edges of canny detector as extra intermediate features')
    parser.add_argument('--model_supervision', type=int, default=0,
                        help='use edges of canny detector as extra intermediate features')
    parser.add_argument('--supervised_num', type=int, default=50,
                        help='use edges of canny detector as extra intermediate features')
    parser.add_argument('--feature_matching_type', type=int, default=0, help='which type of feature matching to use')
    parser.add_argument('--lambda_segment', type=int, default=1,
                        help='weight of the segmentation loss for the generator')
    ...
    if train:
        ...
        parser.add_argument('--freq_fid', type=int, default=2500,
        ...
        parser.add_argument('--bicycle_loss', type=int, default=0,
                            help='which type of cycle loss to use for backward cycle. 0 for none, 1 for L1, 2 for entropy weighted L1')
