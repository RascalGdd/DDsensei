...
def get_dataloaders(opt):
    ...
    dataset_train2 = file.__dict__[dataset_name].__dict__[dataset_name+"2"](opt, for_metrics=False)
    ...
    dataloader_train2 = torch.utils.data.DataLoader(dataset_train2, batch_size = opt.batch_size, shuffle = True,drop_last = True)
    return dataloader_train,dataloader_supervised, dataloader_val, dataloader_train2